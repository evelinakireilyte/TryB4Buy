  ...
  return (
    <div className="homepage">
      ...
      <div className="subtitle">
        ...
        <p>
          {' '}
          Try goods before commiting to buy or let others try yours and earn
          spare cash
        </p>
      </div>
      <div className="homepage_bottom_section">
        <div className="homepage_sub_left">
          ...
          <div>
            <p className="home_line_1">Find an item</p>
          </div>
          <div>
            <p className="home_line_2">Register/Login</p>
          </div>
          <div>
            <p className="home_line_3">Contact the owner</p>
          </div>
          <div>
            <p className="home_line_4">Lets us know how you found it</p>
          </div>
        </div>
        <div className="homepage_sub_right">
          <h4>Looking to make money?</h4>
          <div>
            <p className="home_line_1">Register/Login</p>
          </div>
          <div>
            <p className="home_line_2">Make a post</p>
          </div>
          <div>
            <p className="home_line_3">Respond to users requests</p>
          </div>
          <div>
            <p className="home_line_4">Provide TryB4Buy experience</p>
          </div>
        </div>
      </div>
      <div className="footer">
        <p> Evelina Kireilyte</p>
        <a href="https://www.linkedin.com/in/evelina-kireilyte/">
          <img src={image7} />
        </a>
        <a href="https://github.com/evelinakireilyte">
          <img src={image6} />
        </a>
      </div>
    </div>
